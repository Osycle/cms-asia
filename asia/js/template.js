...
$(function(){
	...
	var Section = {
		...
		beforeRouteEnter: function(to, from, next){
			...
			//var fromUrl = to.path.match(/\/\w+/gim)[0];
		...
		beforeRouteUpdate: function(to, from, next) {
			...
			console.log( "Section:Update ", to, this.href);
			//var url = to.fullPath.replace(/\//gim, "");
			var url = to.fullPath;
...
var Project = {
		...
		beforeRouteEnter: function(to, from, next) {
			console.log( to, from );
			var fromUrl = to.path.match(/\/\w+/gim)[0];
			console.log( "Project:Enter"+fromUrl );
			...
			next(false);
			next(function(){
				console.log( "CKICKCKCKCKKCKKCK"+fromUrl );
				var url = to.fullPath;
				preLoader.preToggle();	
