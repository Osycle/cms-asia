	...
	<footer id="footer" class="container-fluid align-center-sm">
		<div class="container">
			...
			<div class="f-lang col-md-1 align-right-md lang-nav">
				<span class="lang-item active" value="ru"><a href="{$GLOBAL_URL}">RUS</a></span> 
				/ 
				<span class="lang-item" value="en"><a href="{$GLOBAL_URL}/en/index.htm">UZB</a></span>
<!-- 				<span class="lang-item" value="ru"><a href="javascript:void(0);">RUS</a></span> 
				/ 
				<span class="lang-item active" value="en"><a href="javascript:void(0);">UZB</a></span>
				 -->
			</div>
