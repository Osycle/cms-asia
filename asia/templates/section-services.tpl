...
<div class="services" id="sectionContent">
  ...
  <div class="bg-svg row">
    <div class="container">
      	<div class="bg-lines">
        	<svg class="svg-line line-left"><line x1="100%" y1="0" x2="100%" y2="100%" /></svg>
        	<svg class="svg-line line-center"><line x1="50%" y1="0" x2="50%" y2="100%" /></svg>
        	<svg class="svg-line line-right"><line x1="0" y1="0" x2="0" y2="100%" /></svg>
      	</div>
    </div>
  </div>
  <div class="row">
          ...
          <div class="services-content">
            ...
            <div class="services-item">
              ...
              <span class="btn-def" role="button" data-aos="fade-up">
                {*<a data-toggle="modal" data-target="#bidModal" subject="{$navItem2.name}" >Заказать</a>*}
                <a href="#/{$navItem1.fileName}/{$navItem2.fileName}" >Узнать больше</a>
              </span>
            </div>
            {/if}{/foreach}
          </div>
